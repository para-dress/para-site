            ...
            <div className="space-y-6 px-8 py-10 sm:px-12 sm:py-14">
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                <a
                  ...
                  className="inline-flex min-h-14 items-center justify-center rounded-full bg-white px-7 py-4 text-center text-sm font-semibold uppercase tracking-[0.14em] text-[#6f4d1f] shadow-[0_10px_24px_rgba(35,27,24,0.12)] transition hover:opacity-90"
                >
                  <span className="block text-[#6f4d1f]">Book a Consultation</span>
                </a>
                <a
                  href="https://instagram.com/para.dress"
                  target="_blank"
