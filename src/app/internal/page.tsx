  ...
  return (
    <div className="space-y-6">
      <section className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        <div className="rounded-[2rem] border border-[rgba(157,122,63,0.14)] bg-white/76 p-6 shadow-[0_20px_60px_rgba(39,27,16,0.05)]">
          ...
          <p className="mt-4 max-w-2xl text-base leading-8 text-[var(--color-muted)]">
            This dashboard is the internal Para Dress surface for connecting the
            Instagram professional account, viewing business profile information,
            opening direct messages, and replying from one place.
          </p>
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            {[
              ...
              <div
                key={item.label}
                className="rounded-[1.5rem] border border-[rgba(157,122,63,0.12)] bg-[rgba(247,240,234,0.72)] p-4"
              >
                <p className="text-xs uppercase tracking-[0.2em] text-[var(--color-muted)]">
                  {item.label}
                </p>
                <p className="mt-3 text-2xl font-semibold text-[var(--color-ink-strong)]">
                  {item.value}
                </p>
              </div>
            ))}
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        <Link
          href="/internal/instagram"
          className="rounded-[2rem] border border-[rgba(157,122,63,0.14)] bg-white p-6 shadow-[0_20px_60px_rgba(39,27,16,0.04)] transition hover:-translate-y-0.5"
        >
          <p className="text-xs uppercase tracking-[0.24em] text-[var(--color-muted)]">
            Instagram account
          </p>
          <h3 className="mt-3 text-2xl font-semibold text-[var(--color-ink-strong)]">
            View connected profile data
          </h3>
        ...
        >
          ...
          <h3 className="mt-3 text-2xl font-semibold text-[var(--color-ink-strong)]">
            Open inbox and conversation view
          </h3>
          <p className="mt-3 text-sm leading-7 text-[var(--color-muted)]">
