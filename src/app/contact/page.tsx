        ...
        <div className="mx-auto max-w-5xl overflow-hidden rounded-[2rem] border border-[rgba(111,77,31,0.1)] bg-[var(--color-ink-strong)] text-white shadow-[0_24px_80px_rgba(43,29,16,0.12)]">
          <div className="grid gap-0 lg:grid-cols-[1fr_0.8fr]">
            <div className="space-y-6 px-6 py-8 sm:px-10 sm:py-10 lg:px-12 lg:py-12">
              ...
              <textarea placeholder="Tell us which styles you love, your wedding date, or any questions you already have." rows={6} className="min-h-[164px] w-full resize-none rounded-[1.5rem] border border-white/22 bg-white/10 px-5 py-4 text-sm text-white placeholder:text-white/56 outline-none transition focus:border-white/50 focus:bg-white/14" />
              <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                <a href="mailto:hello@paradress.co.uk?subject=Para%20Dress%20Consultation" className="inline-flex min-h-13 items-center justify-center rounded-full bg-[var(--color-cream)] px-7 text-sm font-semibold uppercase tracking-[0.16em] text-[var(--color-ink-strong)] shadow-[0_12px_30px_rgba(18,12,8,0.18)] transition hover:bg-white">
                  Email Us
                </a>
